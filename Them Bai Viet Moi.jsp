             ...
             <div class="panel-body">
              ...
              <div class="btn-group btn-group-justified" role="group" aria-label="...">
				  <div class="btn-group" role="group">
				    <a href="Trang Quan Ly Admin.html"><button type="button" class="btn btn-primary">All File</button></a>
				  </div>
				  <div class="btn-group" role="group">
    		...
    		<div class="panel panel-info">
    			 <div class="panel-heading"><strong><center><h4>Chọn Danh Mục</h4></center></strong></div>
      			...
      			<a href="">Tạo mới danh mục</a>
      				<form>
					    <div class="checkbox">
					      <label><input type="checkbox" value="">Reading 6.0</label>
					    </div>
					    <div class="checkbox">
      			...
      			<center><button class="btn btn-primary" id="btnThemBaiVietMoi" data-toggle="modal" data-target="#thembaiviet">Xuất bản</button> <button class="btn btn-primary" id="btnNhap1">Lưu nháp</button></center>
